...
ALTER TABLE MMH_MEMBER
ADD M_ADDRESS2 VARCHAR2(200);
...
VALUES (MMH_MEMBER_SEQ.NEXTVAL, 'ADMIN2', '1234', '관리자2', 'ADMIN.COM','123', '도로명', '상세주소','Y', 'A');
